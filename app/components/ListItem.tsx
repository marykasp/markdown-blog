...
const ListItem = ({ post }: Props) => {
  ...
  return (
    <li className="cursor-pointer xs:border-none xs:p-0 border border-1 rounded-md dark:border-zinc-800 border-neutral-300 p-4 bg-transparent hover:bg-neutral-200 dark:hover:bg-zinc-700">
